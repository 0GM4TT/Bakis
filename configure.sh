...
log_step "Updating manifests/vms/webserver.py"

sed_replace "manifests/vms/webserver.py" \
    "http://${DEFAULT_MASTER_IP}:30091" \
    "http://${MASTER_IP}:30091" \
    "Updated Prometheus URL in webserver.py"
